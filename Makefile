...
#    Updated: 2019/06/27 13:44:02 by gstrauss         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
	   ...
	   ft_strnlen.c ft_strnncpy.c ft_strxlen.c ft_strcut.c ft_del.c \
...
OBJS = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
	   ...
	   ft_strnlen.o ft_strnncpy.o ft_strxlen.o ft_strcut.o ft_del.o \
